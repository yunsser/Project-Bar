...
<body>
	...
	<article>
		<div class="container" role="main">
			...
			<form name="addForm" id="form" role="form" method="post"
				action="/bar/notice/noticeboard" enctype="multipart/form-data"
				onsubmit="return addNotice();">

				<div class="mb-3">
					<label for="title">제목</label> <input type="text"
						class="form-control" name="title_no" id="title_no"
				...
				<div class="mb-3">
					...
					<label for="author">작성자</label> <span class="form-control"
						...
						type="hidden" name="master" value="${id}" style="border: none;"
						readonly>${id}</span>
				</div>

				<div class="mb-3">
					<label for="content">내용</label>
					<textarea class="form-control" rows="5" name="content_no"
						id="content_no" placeholder="내용을 입력해 주세요"></textarea>
				</div>
	...
	<p class="text-center text-muted"
		...
		Yun Company, Inc</p>
	<script src="/js/notice/noticeboard.js"></script>
	<script
