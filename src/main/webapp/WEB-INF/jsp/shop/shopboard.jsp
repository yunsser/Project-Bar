...
<body>
	...
	<article>
		<div class="container" role="main">
			...
			<form name="addForm" id="form" role="form" method="post"
				action="/bar/shop/board" enctype="multipart/form-data"
				onsubmit="return addShop();">

				<div class="mb-3">
					<label for="name">제품</label> <input type="text"
						class="form-control" name="name" id="name"
						placeholder="제품이름을 입력해 주세요">
				</div>
				...
				<div class="mb-3">
					...
					<textarea class="form-control" rows="5" name="description"
						id="description" placeholder="제품설명을 입력해 주세요"></textarea>
				</div>
				...
				<c:if test="${id=='master'}">
					...
					<button type="button" class="btn btn-sm btn-primary"
						onclick="location.href='/bar/shop/shoplist'">목록</button>
				</div>
	...
	<p class="text-center text-muted"
		...
		Yun Company, Inc</p>
	<script src="/js/shop/shopboard.js"></script>
	<script
